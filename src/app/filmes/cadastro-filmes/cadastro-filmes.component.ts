...
export class CadastroFilmesComponent implements OnInit {
  ...
  id: number;
  // o nome do formGroup referenciado no html é o nome dessa variável.
  cadastro: FormGroup;
  ...
  submit(): void {
    // Esse metodo marca os inputs como clicados.
    this.cadastro.markAllAsTouched();
    if (this.cadastro.invalid) {
      return;
    }
//  getRawVlaue retorna todos os campos do formulario.
